...
echo "<p> current selected picture </p> <img class='img-circle' id='avatar-edit-img' height='128' data-src='imgprofile/" . $id . ".jpg'  data-holder-rendered='true' style='width: 140px; height: 140px;' src='imgprofile/" . $id . ".jpg'/>";
}
else {
	if ($isfemale == true) $filepathpicture = "img/user-female.png";
	else $filepathpicture = "img/user-male.png";
	echo "<h2> upload a picture for your profile </h2> <img class='img-circle' id='avatar-edit-img' height='128' data-src='img/user-female.png'  data-holder-rendered='true' style='width: 140px; height: 140px;' src='".$filepathpicture."'/>";
	}
?>
        </div>
				...
				<div id="changePic" class="" style="display:none">
	                <form id="cropimage" method="post" enctype="multipart/form-data" action="crop-profile.php">
	...
	<script type="text/javascript">
	    ...
	    e.preventDefault();
	    params = {
	            targetUrl: 'crop-profile.php?action=save',
	            action: 'save',
